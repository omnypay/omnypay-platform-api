# OmnyPayPlatform OpenAPI Specification
[![Build Status](https://travis-ci.org/omnypay/omnypay-platform-api.svg?branch=master)](https://travis-ci.org/omnypay/omnypay-platform-api)
...
6. If you did everything correct, https://omnypay.github.io/omnypay-platform-api/ will lead to your new docs
...
- Documentation(ReDoc): https://omnypay.github.io/omnypay-platform-api/
- SwaggerUI: https://omnypay.github.io/omnypay-platform-api/swagger-ui/
- Look full spec:
    + JSON https://omnypay.github.io/omnypay-platform-api/swagger.json
    + YAML https://omnypay.github.io/omnypay-platform-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://omnypay.github.io/omnypay-platform-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://omnypay.github.io/omnypay-platform-api/ with url from the message: `Server started <url>`
